...
// docs/RELEASE.md. When the file is absent, release falls back to debug keys so
...
android {
    ...
    compileOptions {
        ...
        // flutter_local_notifications needs this.
    ...
    buildTypes {
        release {
            signingConfig = if (keystorePropertiesFile.exists()) {
                ...
                // Debug keys so `flutter run --release` works before you add a keystore.
